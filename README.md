...
React JS is a versatile JavaScript framework that makes UI changes easier to implement in a manner that is resource-friendly.

- [ ] What does it mean to _think_ in react?

To visualize the entire program as a functional "tree" in order to understand where data flows and how to properly manage it.
